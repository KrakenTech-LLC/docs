...
<Steps>
  <Step title="Run the host preparation script to install NVIDIA drivers, Docker, and the NVIDIA Container Toolkit:" icon="tools">
    `./prep_host.sh` 
  ...
  <Step title="Configure Environment" icon="house">
  ...
  <Step title="Build the Docker Image" icon="docker">
