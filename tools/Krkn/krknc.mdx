...
![Krkn Webhook Rt](/krkn_webhook_rt.gif)
...
![Toast Notification](/toast_notification.png)
...
<AccordionGroup>
  ...
  <Accordion title="Sender">
    ...
    - confirm     Confirm a new email sender
    - get         Get the current email sender
    - set         Set a new email sender
        ...
        <Accordion title="Set">
          ...
          <AccordionGroup>
            ...
            <Accordion title="Mailgun">
              ...
              | Args       | Description              |
              | ---------- | ------------------------ |
              | from-email | The email to send _from_ |
