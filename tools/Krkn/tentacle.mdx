...
- Your [hub.krkn.tech](http://hub.krkn.tech) username
- Your [hub.krkn.tech](http://hub.krkn.tech) password
- Your Krkns server address
...
<Steps>
  <Step title="Run the installation script:" icon="1">
    ...
    ```bash
    curl -fsSL https://install.krkn.tech/krkn-install.sh | sudo bash
    ```

    Or, if you prefer:

    ```bash
    wget https://install.krkn.tech/krkn-install.sh
    chmod +x krkn-install.sh
    sudo ./krkn-install.sh
    ```
  </Step>
