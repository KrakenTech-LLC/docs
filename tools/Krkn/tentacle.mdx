...
<Steps>
  <Step title="Run the host preparation script to install NVIDIA drivers, Docker, and the NVIDIA Container Toolkit:" icon="1">
    `./prep_host.sh`
  ...
  <Step title="Configure Environment" icon="2">
  ...
  <Step title="Build the Docker Image" icon="3">
